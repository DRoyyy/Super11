    ...
    return (
        <div className="flex items-center justify-between border-gray-300 border p-4 rounded-xl">
            ...
            <div className="h-[70px] w-[60px]">
                <img className="w-full h-full object-cover object-top rounded-xl" src={img} alt="" />
            </div>
            <div>
            ...
            <div>
                <button onClick={() => handleDeletePlayer(id, price)} className="text-3xl"><MdDelete /></button>
            </div>
        </div>
    );
};
